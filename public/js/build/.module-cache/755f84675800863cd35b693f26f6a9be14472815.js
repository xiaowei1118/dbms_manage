  ...
  render: function() {
    return (
      React.createElement("div", {className: "linkTables"}, 
          React.createElement(Griddle, {results: this.state.data1, columnsMetas: this.props.table1ColumnsMetas, showFilter: this.props.showFilter1, showSettings: this.props.showSettings1, columns: ['uid','fname','ftype','ftablename'], onRowClick: this.table1rowclick, filterPlaceholderText: "搜索", settingsText: "设置"}), 
          React.createElement(Griddle, {results: this.state.data2, columnsMetas: this.props.table2ColumnsMetas, showFilter: this.props.showFilter2, showSettings: this.props.showSettings2, columns: ['uid','fname','ftype','fdbname'], noDataMessage: "", filterPlaceholderText: "搜索", settingsText: "设置"})
      )   
    );
  }
});
