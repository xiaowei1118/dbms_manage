var ProductCategoryRow = React.createClass({displayName: "ProductCategoryRow",    //分类行
    render: function() {
        return (React.createElement("tr", null, React.createElement("th", {colSpan: "2"}, this.props.category)));
    }
});

var ProductRow = React.createClass({displayName: "ProductRow",         //产品行
    render: function() {
...
var ProductTable = React.createClass({displayName: "ProductTable",    //产品表单
    render: function() {
        var rows = [];
        var lastCategory = null;    //上一个分类
...
var SearchBar = React.createClass({displayName: "SearchBar",  //搜索框
    render: function() {
        return (
