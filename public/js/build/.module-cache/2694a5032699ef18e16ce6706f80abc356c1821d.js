  ...
  render: function() {
    return (
      React.createElement("div", {className: "tables"}, 
          ...
          React.createElement(Griddle, {results: this.state.data2, tableClassName: "table", showFilter: true, showSettings: "true", columns: ['uid','fname','ftype','fdbname'], noDataMessage: "", filterPlaceholderText: "搜索", settingsText: "设置"})
      )   
    );
  }
});
