  ...
  render: function() {
    return (
      React.createElement("div", {className: "linkTables"}, 
          ...
          React.createElement(Griddle, {results: this.state.data2, showFilter: this.props.showFilter2, showSettings: this.props.showSettings2, columns: ['uid','fname','ftype','fdbname'], noDataMessage: "", filterPlaceholderText: "搜索", settingsText: "设置"})
      )   
    );
  }
});
