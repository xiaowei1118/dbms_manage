var LinkedDataTable = React.createClass({displayName: "LinkedDataTable",
  ...
  changeTable2DataFromServer:function(id){
    $.ajax({
      url:"/get/z_entityproperty?_field=fname,ftype,fdbname,uid&fvisible=1&fentityuid="+id,
      data:{},
      dataType:"json",
      success:function(data){
  ...
  render: function() {
    return (
      React.createElement("div", {className: "tables"}, 
          ...
          React.createElement(Griddle, {results: this.state.data2, tableClassName: "table", showFilter: true, columns: ['uid','fname','ftype','ftablename']})
      )   
    );
  }
});
