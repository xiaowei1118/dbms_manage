  ...
  render: function() {
    return (
      React.createElement("div", {className: "linkTables"}, 
          React.createElement(Griddle, {results: this.state.data1, showFilter: this.props.showFilter1, showSettings: this.props.showSettings1, columns: ['uid','fname','ftype','ftablename'], onRowClick: this.table1rowclick, filterPlaceholderText: "搜索", settingsText: "设置"}), 
