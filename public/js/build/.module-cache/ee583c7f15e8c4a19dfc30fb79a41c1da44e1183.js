  ...
  render: function() {
    return (
      React.createElement("div", {className: "tables"}, 
          React.createElement(Griddle, {results: this.state.data1, showFilter: true, columns: ['uid,fname,ftype,ftablename']}), 
          React.createElement(Griddle, {results: this.state.data2, showFilter: true})
      )   
    );
  }
});
