  ...
  render: function() {
    return (
      React.createElement("div", {className: "linkTables"}, 
          ...
          React.createElement(Griddle, {results: this.state.data2, columnMetadata: this.props.table2ColumnsMetas, showFilter: this.props.showFilter2, showSettings: this.props.showSettings2, columns: ['uid','fname','ftype','fdbname'], noDataMessage: this.noDataMessage, filterPlaceholderText: this.filterPlaceholderText, settingsText: this.settingsText})
      )   
    );
  }
});
