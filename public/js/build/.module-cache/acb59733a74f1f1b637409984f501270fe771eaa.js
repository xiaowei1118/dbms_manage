...
var SearchBar = React.createClass({displayName: "SearchBar",
    handleChange: function() {             //处理input的输入和checkbox的点击事件
        this.props.onUserInput(            //onUserInput 从上级控件作为属性传过来,this代表当前对象
        ...
        return (
            React.createElement("form", null, 
                React.createElement("input", {
                    ...
                    ref: "filterTextInput", //ref属性可以通过this.refs直接调用属性，该属性和checkbox直接关联
                    onChange: this.handleChange}//调用input和checkbox的处理
                ), 
...
ReactDOM.render(
    React.createElement(FilterableProductTable, {products: PRODUCTS}),//渲染到前端的组件
    document.getElementById('content')            //绑定到指定位置的标签
);