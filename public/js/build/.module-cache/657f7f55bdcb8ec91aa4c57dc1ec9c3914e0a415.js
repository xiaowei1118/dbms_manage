  ...
  render: function() {
    return (
      React.createElement("div", {className: "linkTables"}, 
          React.createElement(Griddle, {results: this.state.data1, columnMetadata: this.props.table1ColumnsMetas, showFilter: this.props.showFilter1, showSettings: this.props.showSettings1, onRowClick: this.table1rowclick, filterPlaceholderText: this.filterPlaceholderText, settingsText: this.settingsText}), 
          React.createElement(Griddle, {results: this.state.data2, columnMetadata: this.props.table2ColumnsMetas, showFilter: this.props.showFilter2, showSettings: this.props.showSettings2, noDataMessage: this.noDataMessage, filterPlaceholderText: this.filterPlaceholderText, settingsText: this.settingsText})
      )   
    );
  }
});
