  ...
  render: function() {
    return (
      React.createElement("div", {className: "tables"}, 
          React.createElement(Griddle, {results: this.state.data1, tableClassName: "table", showFilter: true, showSettings: "true", columns: ['uid','fname','ftype','ftablename'], onRowClick: this.table1rowclick}), 
