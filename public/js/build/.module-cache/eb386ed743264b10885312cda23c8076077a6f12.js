  ...
  render: function() {
    return (
      React.createElement("div", {className: "DataTable"}, 
         "columnMetadata=", this.props.table1ColumnsMetas, " showFilter=", this.props.showFilter1, " showSettings=", this.props.showSettings1, " columns=", this.getColumns(this.props.table1ColumnsMetas), " onRowClick=", this.table1rowclick, " filterPlaceholderText=", this.props.filterPlaceholderText, " settingsText=", this.props.settingsText
      )
    );
  }
});
