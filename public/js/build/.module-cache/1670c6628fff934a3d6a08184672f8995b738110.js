  ...
  render: function() {
    return (
      React.createElement("div", {className: "linkTables"}, 
          ...
          React.createElement(Griddle, {results: this.state.data2, columnMetadata: this.props.table2ColumnsMetas, showFilter: this.props.showFilter2, showSettings: this.props.showSettings2, columns: this.getColumns(this.props.data2), noDataMessage: this.props.noDataMessage, filterPlaceholderText: this.props.filterPlaceholderText, settingsText: this.props.settingsText, nextText: this.props.nextText, previousText: this.props.previousText, maxRowsText: this.props.maxRowsText, maxRowsText: this.props.maxRowsText})
      )   
    );
  }
});
